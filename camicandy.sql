...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='* Falta añadir un trigger o un CHECK para revisar que sólo clientes_id o proveedores_id es NULL pero no ambos\\\\n* También falta verificar que sólo el administrador puede registrar una compra\\\\n* columna monto: Si es positivo la transacción fue una venta a un cliente, si es negativo fue una compra a un proveedor';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transacciones_tiene_productos` VALUES (1,1,60),(1,2,80),(2,22,2),(2,19,1),(2,18,1),(3,2,2),(4,1,4),(4,4,1),(5,7,4),(5,6,1),(5,14,1),(6,20,4),(6,2,4),(7,8,2),(7,7,7),(7,4,1),(7,3,1),(8,2,4),(9,5,2),(9,6,4),(9,14,2),(10,10,10),(10,12,2),(11,7,1),(11,6,1),(12,5,1),(12,4,1),(13,7,4),(14,2,7);
...
-- Dump completed on 2024-07-18  1:58:49
